class AcmeV1::Client::JWK::ECDSA < AcmeV1::Client::JWK::Base
  ...
  def to_h
    {
      ...
      kty: 'EC',
      x: AcmeV1::Client::Util.urlsafe_base64(coordinates[:x].to_s(2)),
      y: AcmeV1::Client::Util.urlsafe_base64(coordinates[:y].to_s(2))
    }
  end
