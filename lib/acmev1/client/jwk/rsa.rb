class AcmeV1::Client::JWK::RSA < AcmeV1::Client::JWK::Base
  ...
  def to_h
    {
      e: AcmeV1::Client::Util.urlsafe_base64(public_key.e.to_s(2)),
      kty: 'RSA',
      n: AcmeV1::Client::Util.urlsafe_base64(public_key.n.to_s(2))
    }
  end
